...
x_steps = [1000]          # Array N-size
y_steps = [1000]          # Array M-size
iterations = 1         # The amount of times the whole thing runs
min_value = -100          # Minimum value in each matrix entrance
max_value = 100           # Maximum value in each matrix entrance



def AlgorithmMSP_Sequential(A, N: int, M: int):
    """
    MSP Sequential
    =====
