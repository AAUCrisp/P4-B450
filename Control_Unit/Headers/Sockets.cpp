...
void *transmit_command_LTE(int socketvalue, int socketlength, char *message) {
    ...
    //     printf("tempmsgCoordsLTE2 == msgCoords\n");
    //    printf("%s == %s\n", tempmsgCoordsLTE2, msgCoords);
    // }
...
void *transmit_command_WiFi(void *socket, char *message) {
    ...
    //     printf("tempmsgCoordsWiFi2 == msgCoords\n");
    //     printf("%s == %s\n", tempmsgCoordsWiFi2, msgCoords);
    // }
...
void *transmit_command(int socketvalue, int socketlength, char *message, int gsv) {
    ...
    if ((gsv == 0) || (gsv == 2)) {
        ...
        transmit_command_LTE(socketvalue, socketlength, message);
    }
    if (print_act_out == 1) {
        cout << "\n  ======== end ==========\n  ==== SEND COMMAND ====\n  ======================\n"
             << endl;
