...
int main() {
    ...
    bindLTE = bind(sockLTE2, (struct sockadd *)&ServerLTE, sizeof(struct sockaddr));
    ...
    while (1) {
        ...
        */
        ...
        pthread_create(&T3, NULL, transmit_LTE, NULL);
        pthread_create(&T4, NULL, transmit_WiFi, NULL);
    }
}
